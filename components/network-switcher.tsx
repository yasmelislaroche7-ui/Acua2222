...
export function NetworkSwitcher({ address, activeNetwork, onSwitch, onBnbAddressChange }: NetworkSwitcherProps) {
  ...
  return (
    <div className="relative" ref={panelRef}>
      ...
      {/* Panel */}
      {open && (
        <div className="absolute top-full right-0 mt-1.5 w-72 rounded-2xl border border-[oklch(0.22_0.025_245)] bg-[oklch(0.09_0.018_245)] shadow-[0_8px_32px_rgba(0,0,0,0.6)] z-50 overflow-hidden max-h-[85dvh] overflow-y-auto">

          {/* Header */}
          <div className="px-4 py-3 border-b border-[oklch(0.18_0.02_245)] bg-[oklch(0.11_0.02_245)]">
            <p className="text-[9px] font-bold text-[oklch(0.45_0.01_230)] uppercase tracking-wider mb-0.5">Wallet conectada · World App</p>
