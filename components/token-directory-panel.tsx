...
const TOKENS: TokenEntry[] = [
  ...
  { name: 'Fire Token', symbol: 'FIRE', type: 'token', address: '0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee', color: 'orange', emoji: '🔥', description: 'Token de fuego del ecosistema' },
  { name: 'Sushi Token', symbol: 'SUSHI', type: 'token', address: '0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee', color: 'pink', emoji: '🍣', description: 'DeFi reward token' },
  ...
  { name: 'wrapped COP', symbol: 'wCOP', type: 'token', address: '0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee', color: 'yellow', emoji: '🇨🇴', description: 'Peso colombiano envuelto' },
  { name: 'wrapped ARS', symbol: 'wARS', type: 'token', address: '0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee', color: 'sky', emoji: '🇦🇷', description: 'Peso argentino envuelto' },
  { name: 'BTC H2O', symbol: 'BTCH2O', type: 'token', address: '0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee', color: 'amber', emoji: '₿', description: 'Bitcoin del ecosistema Acua' },
  { name: 'Air Token', symbol: 'AIR', type: 'token', address: '0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee', color: 'violet', emoji: '🌬️', description: 'Token del aire' },
  { name: 'UTH2 Token', symbol: 'UTH2', type: 'token', address: '0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee', color: 'teal', emoji: '⚗️', description: 'Uranio para minería H2O' },
