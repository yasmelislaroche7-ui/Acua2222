...
export const NETWORKS: Record<NetworkId, NetworkConfig> = {
  ...
  bnb: {
    ...
    shortName: 'BNB',
    chainId: 56,
    rpc: `https://bnb-mainnet.g.alchemy.com/v2/${process.env.ALCHEMY_API_KEY ?? 'bVo646pb8L7_W_nahCoqW'}`,
    nativeSymbol: 'BNB',
    nativeDecimals: 18,
    color: '#f0b90b',
  ...
  polygon: {
    ...
    shortName: 'POL',
    chainId: 137,
    rpc: `https://polygon-mainnet.g.alchemy.com/v2/${process.env.ALCHEMY_API_KEY ?? 'bVo646pb8L7_W_nahCoqW'}`,
    nativeSymbol: 'POL',
    nativeDecimals: 18,
    color: '#8247e5',
